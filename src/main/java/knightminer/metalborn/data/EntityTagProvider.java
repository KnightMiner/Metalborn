...
public class EntityTagProvider extends EntityTypeTagsProvider {
  ...
  protected void addTags(Provider pProvider) {
    tag(MetalIds.iron).add(EntityType.GHAST, EntityType.PHANTOM, EntityType.HOGLIN, EntityType.ZOGLIN, EntityType.RAVAGER);
    ...
    tag(MetalIds.roseGold).add(EntityType.SLIME); // TODO: tinkers slime
  }
